...
//       mViewBinding.rvList.addItemDecoration(new FastDividerDecoration(getResources().getColor(R.color.yellow_300),FastUtil.dp2px(this,1),FastDividerDecoration.VERTICAL));
...
//       mViewBinding.rvList.setAdapter(mAdapter = new DecorationAdapter());
//       mViewBinding.rvList.addItemDecoration(new FastDividerDecoration(getResources().getColor(R.color.yellow_300),FastUtil.dp2px(this,1),FastDividerDecoration.HORIZONTAL));
//       mAdapter.setNewData(FastUtil.listOf("小米","大米","面粉","小麦","黑米","薏米","玉米"));

        mViewBinding.rvList.setLayoutManager(new GridLayoutManager(this,3));
        mViewBinding.rvList.setAdapter(mAdapter = new DecorationAdapter());
        mViewBinding.rvList.addItemDecoration(new FastSpacingDecoration(3,FastUtil.dp2px(this,10),true));
        mAdapter.setNewData(FastUtil.listOf("小米","大米","面粉","小麦","黑米","薏米","玉米"));
    }
}
