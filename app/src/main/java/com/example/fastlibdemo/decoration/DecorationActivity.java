...
//       mViewBinding.rvList.addItemDecoration(new FastDividerDecoration(this,getResources().getColor(R.color.yellow_300),FastDividerDecoration.VERTICAL));
...
//       mViewBinding.rvList.setAdapter(mAdapter = new DecorationAdapter());
//       mViewBinding.rvList.addItemDecoration(new FastDividerDecoration(this,getResources().getColor(R.color.yellow_300),FastDividerDecoration.HORIZONTAL));
//       mAdapter.setNewData(FastUtil.listOf("小米","大米","面粉","小麦","黑米","薏米","玉米"));
